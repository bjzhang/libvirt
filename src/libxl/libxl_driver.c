 ...
 * commit XXXX.  First, timeout modify callbacks will only be invoked with an
 * abs_t of {0,0}, i.e. make the timeout fire immediately.  Prior to this
 * commit, timeout modify callbacks were never invoked.  Second, timeout
 * deregister hooks will no longer be called.
 */
static int
