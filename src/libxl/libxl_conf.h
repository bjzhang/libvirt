...
enum libxlMigrationJobPhase {
    LIBXL_MIGRATION_PHASE_NONE = 0,
    LIBXL_MIGRATION_PHASE_BEGIN3,
    LIBXL_MIGRATION_PHASE_PERFORM3,
    LIBXL_MIGRATION_PHASE_PERFORM3_DONE,
    LIBXL_MIGRATION_PHASE_CONFIRM3_CANCELLED,
    LIBXL_MIGRATION_PHASE_CONFIRM3,
    LIBXL_MIGRATION_PHASE_PREPARE,
    LIBXL_MIGRATION_PHASE_FINISH3,

    LIBXL_MIGRATION_PHASE_LAST
};
VIR_ENUM_DECL(libxlMigrationJobPhase)
